...
#endif // moved to csp_task.hpp

template <class DerivedActor> class actor : public detail::base_actor
{
public:
    void associate_runner(task_runner& message_runner) {
        detail::base_actor::associate_runner(message_runner);
    }
